...
@WebServlet(urlPatterns = { "/workOrder", "/workOrderDel", "/workOrderRetouch", "/workSafety", "/workSafetyDel",
      "/workSafetyRetouch", "/workQuality", "/workQualityDel", "/workQualityRetouch", "/facilityUpdate",
      "/workReport" })
public class WorkOrderServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      if (local.equals("/workOrder")) {
         ...
         request.getRequestDispatcher("workReport.jsp").forward(request, response);
      }
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      if (local.equals("/workOrder") || local.equals("/workSafety") || local.equals("/workQuality")
         ...
         if (local.equals("/workOrderDel")) {
            ...
            || local.equals("/workQualityRetouch") || local.equals("/facilityUpdate")) {
