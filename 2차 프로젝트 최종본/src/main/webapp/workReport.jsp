...
<!--                         </div> -->
              ...
              <%
                ...
                for(int i = 0; i < list.size(); i++) {
                  ...
                  int facilitySeq = list.get(i).getFacilitySeq();
                  int goodsSeq = list.get(i).getGoodsSeq();
                  String facilityDetail = list.get(i).getFacilityDetail();
                  int clear = list.get(i).getClear();
                  int workerId = list.get(i).getWorkerId();
                  String sendTime = list.get(i).getSendTime();
                  String sname = list.get(i).getSname();
                  String sphone = list.get(i).getSphone();
                  String smail = list.get(i).getSmail();
                  String sduty = list.get(i).getSduty();
              %>
