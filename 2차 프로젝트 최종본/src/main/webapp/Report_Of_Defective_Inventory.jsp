					...
					<div class="Refund_page">
						...
						<div class="Refund_Application_Record">
							<div class="table_RAR">
								...
								<%
								List list2 = (List) request.getAttribute("list3");
								System.out.println(list2.size());
								for (int i = 0; i < list2.size(); i++) {

									Rodi_DTO dto2 = (Rodi_DTO) list2.get(i);
								%>
								...
								<div class="row_RAR">
									...
									<div class="cell_RAR">
										<div class="dto0"><%=dto2.get품목()%></div>
									</div>
									<div class="cell_RAR">
										<div class="dto1"><%=dto2.get수량()%></div>
										<div class="dto2" style="display: none"><%=dto2.getDe_content()%></div>
										<div class="dto3" style="display: none"><%=dto2.getDe_etc()%></div>
										<div class="dto3" style="display: none"><%=dto2.getS_number()%></div>


										<div class="dto4" style="display: none"><%=dto2.getS_number()%></div>
									</div>
									<div class="cell_RAR">
										<input type="text" value="팀장 정장훈" READONLY>
									</div>
								</div>
								<%
								}
...
if (name != null) {%> block<%} else {%> none <%}%> ;"></div>
					...
					<div class="itemList">
						<div class="item">
							...
							for (int i = 0; i < list.size(); i++) {
								...
								Rodi_DTO rodiDTO = (Rodi_DTO) list.get(i);
								System.out.println(rodiDTO.get품목());
							%>
							<div class="itemInfor2">
								<div class="pic">
									<input type="checkbox" class="pic1">
								</div>
								<div class="itemMesId"><%=rodiDTO.getMesId()%></div>
								<div class="itemName"><%=rodiDTO.getMesGrade()%></div>
								<div class="itemIndex1"><%=rodiDTO.getBCount()%></div>
								<div class="itemIndex2"><%=rodiDTO.getMesContent()%></div>
		...
		<div class="infor_item_box">
			<div class="infor_item">
				...
				<div class="infor_item_img">
					<img
						src="https://media.discordapp.net/attachments/1186454147558551552/1227443198800957511/image.png?ex=66286c8f&is=6615f78f&hm=2e5febad7a311276a0c6cc69de336e996dd2171ffbee96fe9c0558d5f0d7db22&=&format=webp&quality=lossless&width=628&height=628">
				</div>
		...
		<!-- 팝업2 -->
		<form method="get" class="ri" action="ri">
	...
	<script>
		    ...
		    itemInfor2.forEach(function(event) {
		        ...
		        console.log(itemName);
		            ...
		            newRow.innerHTML = `
		            	...
		            	<div class="row_RR1">
		        		<div class="cell_RR">
		        			<input type="text" class="item_name" value="\${itemName}" readonly="">
		        		</div>
		        		<div class="cell_RR">
		        			<input type="number" class="count" value="\${itemIndex1}">
		        		</div>
		        		<div class="cell_RR">
		        			<div class="text_RR">
		        				<div class="text_rr1">\${itemIndex3}</div>
		        				<div class="text_rr2">\${itemIndex4}</div>
		        				<input type = "hidden" class = "text_company" value ="\${company}">
		        				<input type = "hidden" class="text_mesId" value ="\${itemMesId}">
        ...
        document.addEventListener('click', function (event) {
            if (event.target.classList.contains('add_Stock')) {
                let imageBox = event.target.closest(".but_box").querySelector(".items_imglink");
                imageBox.src = "https://media.discordapp.net/attachments/1186454147558551552/1227443198800957511/image.png?ex=66286c8f&is=6615f78f&hm=2e5febad7a311276a0c6cc69de336e996dd2171ffbee96fe9c0558d5f0d7db22&=&format=webp&quality=lossless&width=628&height=628";
            }
        });
		...
		// 관리자에게 반품요청
                ...
                for (i = 0; i < rs.length; i++) {
                    ...
                    newRR.innerHTML = `
        <input type="text" class="RRN" name = "itemName" value="\${item_name}"> : <input type="text" class="RRC" name = "itemCount" value="\${count}" readonly>
        <input type="text" style="display:none" name = "text_rr1" value = "\${text_rr1}">
        <input type="text" style="display:none" name = "text_rr2" value = "\${text_rr2}">
        <input type="text" style="display:none" name = "text_company" value = "\${text_company}">
        <input type="text" style="display:none" name = "text_mesId" value = "\${text_mesId}">
        `;
				  ...
				  if(checkbox != null && checkbox.checked){
					  ...
					  let newRR = document.createElement('div');
	                    ...
	                    newRR.innerHTML = `
	    	                ...
	    	                <input type="hidden" class="RRC" name = "s_number" value="\${D4}" readonly>
