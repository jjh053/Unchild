...
<%@ page import="test.jsp.PagingDTO"%>
...
<body>
			...
			<section>
				<article>
					...
					<div class="pageViewBox">
						페이지에 표시할 품목 수 <select class="pageView">
							<option>-선택-</option>
					...
					<div class="items">
						...
						<div class="table2_box">
							<table class="table2">
								<tbody class="row_box">
									<%
									List list = (List) request.getAttribute("listPaging");

									for (int i = 0; i < list.size(); i++) {

										PagingDTO dto = (PagingDTO) list.get(i);
									%>
									<tr class="row">
					...
					<div style="margin-top: 10px; width: 450px; height: 50px;">
					...
					<div class="record_items_img_box">
						<div class="record_items_img">
							<img class="record_items_imglink"
								src="https://media.discordapp.net/attachments/1186454147558551552/1227443198800957511/image.png?ex=66286c8f&is=6615f78f&hm=2e5febad7a311276a0c6cc69de336e996dd2171ffbee96fe9c0558d5f0d7db22&=&format=webp&quality=lossless&width=419&height=419">
						</div>
    ...
    document.querySelector(".pageView").addEventListener("change", function() {
        var selectedValue = this.value;
        var url = "/mes_project/ot?pageView=" + selectedValue;
...
// 	document.addEventListener("DOMContentLoaded", function() {
	let pageView = document.querySelector(".pageView").value;
	...
	for(let i = 0; i<iValue.length; i++ ){
		...
		window.location.href="/mes_project/ot?pageNum="+iValue[i].value+"&pageView="+pageView+"";
	});
		if(ipValue2 != null){
		ipValue2.addEventListener("click", function(){
		window.location.href="/mes_project/ot?pageNum="+(pageNumV.value-1)+"&pageView="+pageView+"";
	});
		}
		
		if(ipValue3 != null){
		ipValue3.addEventListener("click", function(){
		window.location.href="/mes_project/ot?pageNum="+(parseInt(pageNumV.value)+1)+"&pageView="+pageView+"";
	});
		}
	}
    ...
    document.querySelector(".items_img_choice").addEventListener('click', function () {
        ...
        document.querySelector(".items_imglink").src = "https://media.discordapp.net/attachments/1186454147558551552/1227443198800957511/image.png?ex=66286c8f&is=6615f78f&hm=2e5febad7a311276a0c6cc69de336e996dd2171ffbee96fe9c0558d5f0d7db22&=&format=webp&quality=lossless&width=419&height=419";
    });
