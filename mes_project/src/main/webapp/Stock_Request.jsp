							...
							<div class="Stock_Request_History">
								<div class="table_SPH">
									...
									for (int i = 0; i < list2.size(); i++) {
										...
										Sr_DTO dto2 = (Sr_DTO) list2.get(i);
									%>
									...
									<div class="row_SPH">
										...
										<div class="cell_SPH_D1">
											<input type="text" name="rejectName"
												value="<%=dto2.getMesGrade()%>" READONLY>
										</div>
										<div class="cell_SPH_D2">
											<input type="text" name="rejectCount"
												value="<%=dto2.getOrderQuantity()%>" READONLY>
										</div>
										...
										<div class="cell_SPH_D4">
											<div class="backbut">
												<a href="sd?seq=<%=dto2.getMesid()%>">반려</a>
											</div>

											<!-- 											<input type="button" -->
											<%-- 												onclick="deletePost(<%=dto2.getMesid()%>)" class="backbut" --%>
											<!-- 												value="반려"> -->
										</div>
									</div>
									<%
									...
									%>
									<!-- <div class="row_SPH">
                                    <div class="cell_SPH"><input type="text" value="메인보드2" READONLY></div>
                                    <div class="cell_SPH"><input type="text" value="200" READONLY></div>
                                    <div class="cell_SPH"><input type="text" value="팀장 정장훈" READONLY></div>
                                </div>
                                <div class="row_SPH">
                                    <div class="cell_SPH"><input type="text" value="메모리" READONLY></div>
                                    <div class="cell_SPH"><input type="text" value="15" READONLY></div>
                                    <div class="cell_SPH"><input type="text" value="팀장 정장훈" READONLY></div>
                                </div>
                                 -->
								</div>
...
if (name != null) {%> block<%} else {%> none <%}%> ;"></div>
					...
					<div class="itemList">
						<div class="item">
							...
							for (int i = 0; i < list.size(); i++) {
								...
								Sr_DTO srDTO = (Sr_DTO) list.get(i);
							%>
							<div class="itemInfor2">
								...
								<div class="itemMesName" style="display: none">
									<%=srDTO.getMesName()%></div>
								<div class="itemName"><%=srDTO.getMesGrade()%></div>
								<div class="itemIndex2"><%=srDTO.getGCount()%></div>
								<div class="itemMesPrice" style="display: none">
									<%=srDTO.getMesPrice()%></div>
								<div class="itemIndex1"><%=srDTO.getMesContent()%></div>
								<div class="itemMGLoc" style="display: none">
									<%=srDTO.getGLoc()%></div>
								<div class="itemBCount" style="display: none">
									<%=srDTO.getBCount()%></div>
								<div class="itemBLoc" style="display: none">
									<%=srDTO.getBLoc()%></div>
		...
		<form method="get" class="sd" action="sd">
			<div class="requestD" id="requestD" style="display: none;">
				...
				<div class="requestList">
					...
					<div class="requestList5">업체전화번호</div>
				...
				<div class="orderingBox2">
					...
					<div class="orderingItemList">
						<div class="orderingItem">
							...
							<%
							List list3 = (List) request.getAttribute("list4");

							for (int i = 0; i < list3.size(); i++) {

								Sr_DTO srDTO3 = (Sr_DTO) list3.get(i);
							%>
							<div class="orderingItemInfor2">
								<div class="orderringItemName"><%=srDTO3.getOrderNumber()%></div>
								<div class="orderringItemIndex1"><%=srDTO3.getMesGrade()%></div>
								<div class="orderringItemIndex2"><%=srDTO3.getOrderQuantity()%></div>
								<div class="orderringItemIndex3"><%=srDTO3.getCo_Number()%></div>
								<div class="orderringItemIndex4"><%=srDTO3.getOrderStatus()%></div>
							</div>
							<%
							}
							%>
				  ...
				  if(checkbox.checked){
					 ...
					 // console.log(D2);
					  ...
					  let newRR = document.createElement('div');
	                    ...
	                    newRR.innerHTML = `
	                <input type="text" class="RRN" name = "itemName" value="\${D1}" readonly> 
	                <input type="text" class="RRC" name = "itemCount" value="\${D2}" readonly>
	                ...
	                <input type="text" class="comNum1" name = "comNum1" value="" readonly>
          ...
          //      <input type="text" name ="itemMGLoc" style="display : none" value= "\${itemMGLoc}" readonly>
            //    <input type="text" name ="itemBCount" style="display : none" value= "\${itemBCount}" readonly>
              //  <input type="text" name ="itemBLoc" style="display : none" value= "\${itemBLoc}" readonly>
                    ...
                    newRR.innerHTML = `
                <input type="text" class="RRN2" name = "itemName" value="\${item_name}"> 
                <input type="text" style="display:none" name = "length" value = "\${lengtn}">:
                <input type="text" class="RRC2" name = "itemCount" value="\${count}" readonly>
                `;
